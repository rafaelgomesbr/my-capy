...
const faqs = [
  {
    ...
    answer: "É útil para criar personagens fictícios, popular bancos de dados de teste, gerar usuários em ambientes de desenvolvimento ou criar nomes para projetos criativos.",
  },
  {
    question: "Os nomes gerados são de pessoas reais?",
    answer: "Não. Os nomes são combinações aleatórias de primeiro nome e sobrenome comuns no Brasil. Qualquer semelhança com pessoas reais é coincidência.",
  },
];
